...
class SignalingGameModule(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--receiver-entropy-coeff", type=float, default=0.1)
    ...
    def add_noise(self, messages, disable_noise=False):
        if not disable_noise and self.params.noise > 0:
            ...
            messages[(indices == 1) & (messages != 0)] = torch.randint(0, self.params["vocab_size"], (len(messages_noisy),), device=messages.device)
        return messages
